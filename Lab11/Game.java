...
public class Game extends JFrame implements ActionListener {
	...
	int score;
	// Reminder!!!!!!! : addActionListener() will be double if u dont do
	// correctly!!!
	...
	private void nextQuestion() {
		Question question = Question.randomQuestion(); // return new Question1("What is the capital city of
														// "+country+"?", city, otherCity);
		questionLabel.setText(question.getText()); // Print Question

		Random mm = new Random(); // int index = random.nextInt(countries.length);
		int num = mm.nextInt(50);
		if (num % 2 == 0) {
